export default {
	...
	login: {
		dingtalkProcessing: 'Processing DingTalk login...',
		dingtalkAuthFailed: 'DingTalk authorization failed',
		dingtalkStateMismatch: 'State verification failed, please try again',
		dingtalkLoginFailed: 'DingTalk login failed',
		dingtalkInvalidResponse: 'Invalid response data',
		dingtalkConfigError: 'DingTalk configuration error',
	},
	user: {
