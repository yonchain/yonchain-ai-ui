<template>
	<div class="model-form-dialog-container">
		<el-dialog 
				...
				<el-row :gutter="20">
					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('model.name')" prop="name">
							<el-input placeholder="请输入模型名称" v-model="dataForm.name"></el-input>
						</el-form-item>
					</el-col>

					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('model.type')" prop="type">
							<el-tooltip content="编辑模式下不能修改模型类型" placement="top" :disabled="!dataForm.id">
								<el-select 
					...
					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('model.modelId')" prop="model_id">
							<el-input placeholder="请输入模型ID" v-model="dataForm.model_id"></el-input>
						</el-form-item>
					</el-col>
					...
					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('model.description')" prop="description">
							<el-input :rows="4" type="textarea" placeholder="请输入模型描述" v-model="dataForm.description"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script lang="ts" name="systemModelDialog" setup>
import { addObj, getObj, putObj } from '/@/api/model/index';
...
const dataRules = ref({
	...
	provider_id: [{ required: true, message: '请选择模型提供商', trigger: 'change' }],
	model_id: [{ required: true, message: '模型ID不能为空', trigger: 'blur' }],
...
const openDialog = async (id: string) => {
	...
	if (id) {
		...
		dataForm.type = res.type;
		dataForm.description = res.description;
		dataForm.provider_id = res.provider_id;
		dataForm.model_id = res.model_id;
