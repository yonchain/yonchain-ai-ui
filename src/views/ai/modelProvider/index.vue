<template>
	<div class="layout-padding ai-provider-index">
		<div class="layout-padding-auto layout-padding-view">
			<el-row v-show="showSearch" class="search-card">
				<div class="card-container">
					<el-form ref="queryRef" :inline="true" :model="queryForm" @keyup.enter="initData">
						<el-form-item :label="$t('provider.name')" prop="name" class="search-input">
							<el-input 
								v-model="queryForm.name" 
								:placeholder="$t('provider.inputProviderNameTip')" 
								clearable 
				...
				<div class="mb-[16px] flex items-center justify-between" style="width: 100%">
					...
					<el-button-group class="button-group">
						<el-button 
							icon="Plus" 
							type="primary" 
							@click="providerDialogRef.openDialog()"
			...
			<ul class="provider-list">
				<el-empty 
					...
					class="w-full"
				/>
				<li v-for="item in providerList" :key="item.id">
					<div class="flex">
					...
					<div class="provider-actions">
						<el-button type="primary" size="small" icon="Edit" @click="providerDialogRef.openDialog(item.id)">{{ $t('common.editBtn') }}</el-button>
		...
		<user-form ref="providerDialogRef" @refresh="initData()" />
	</div>
</template>

<script lang="ts" name="systemProvider" setup>
import { delObj, pageList } from '/@/api/modelProvider/index';
