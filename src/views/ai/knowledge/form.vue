<template>
	<div class="knowledge-form-dialog-container">
		<el-dialog 
				...
				<el-row :gutter="20">
					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('knowledge.name')" prop="name">
							<el-input placeholder="请输入知识库名称" v-model="dataForm.name"></el-input>
						</el-form-item>
					</el-col>

					<el-col :span="24" class="mb20">
						<el-form-item :label="$t('knowledge.knowledgeDescription')" prop="description">
							<el-input :rows="2" type="textarea" placeholder="请输入知识库描述" v-model="dataForm.description"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
import { addObj, getObj, putObj } from '/@/api/knowledge/index';
